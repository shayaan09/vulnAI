...
There were multiple components, class info, data structures and passes I needed to keep track of at once and I was in a constant state of working memory overload.
